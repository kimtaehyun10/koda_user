...
public class MemberMenuController {
	...
	//로그인팝업
	@RequestMapping(value = "/mem/popup/loginPopup.p")
    public String loginPopup(HttpServletRequest request, ModelMap model) throws Exception {
		
		return "mem/popup/loginPopup";
    }
