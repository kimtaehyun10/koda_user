                ...
                <div class="memorial__detail-content">
                    <header>
                        ...
                        <div class="info"> 
                            ...
                            <div class="col">
                                	조회수 <strong><c:out value="${openData.brdReadNum }"/></strong>
                            </div>
                        </div>
                        <c:if test="${not empty openData.brdFileOrgNm }">
                        <div class="attachFile flex items-center">
                            <span class="inline-block">첨부파일</span>
                            <a href="#" onclick="goDown('${openData.brdFileOrgNm}','/${openData.brdFileNm}');"><c:out value="${openData.brdFileOrgNm }"/></a>
                        </div>
						</c:if>
                    </header>
                    ...
                    <div class="memorial__detail-body border-type">
                        ...
                        <div class="content" style="white-space: pre-line;line-height:1.5em;">
							${cfn:nl2br(openData.brdContents) }   
                        </div>
