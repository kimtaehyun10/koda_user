                ...
                <div class="memorial__detail-content">
                    <header>
                        ...
                        <div class="info">
                            ...
                            <div class="col">
                                	조회수 <strong><c:out value="${human.brdReadNum }"/></strong>
                            </div>
                        </div>
                        <c:if test="${not empty human.brdFileOrgNm }">
                        <div class="attachFile flex items-center">
                            <span class="inline-block">첨부파일</span>
                            <a href="#" onclick="goDown('${human.brdFileOrgNm}','/${human.brdFileNm}');"><c:out value="${human.brdFileOrgNm }"/></a>
                        </div>
						</c:if>
                    </header>
