...
<body>
        <div class="wrap">
				<div class="section">
					<div class="flex videotxtbox">
						<div class="video">
							<iframe id='iframe__G0krUbFPpgg_3' src="https://www.youtube.com/embed/G0krUbFPpgg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<div class='video_youtube1' id='btnplay__G0krUbFPpgg_3'>
								<div>
									<span class='bg1'></span>
									<span class='ly1'>
									<a href="javascript:fn_video_youtube1('G0krUbFPpgg_3');"><span class='icon1'>▶</span>영상으로 보기</a>
									</span>
								</div>
							</div>
						</div>
						<div class="col-1">
							...
							<p class="section__description">
								<strong>“장기기증은 뇌의 모든 기능을 상실한 <span class="text-red-500">뇌사상태</span>에서만 가능합니다”</strong><br/>
								<br/>
								뇌사는 몸은 아직 따뜻하지만 자발호흡이 불가능하고 어떤 치료에도 회복이 불가능하여 수 일 또는 수 주 이내 사망에 이르게 되는 상태입니다.<br/>
								흔히 혼동하고 있는 식물인간의 경우에는 뇌사가 아님으로 기증이 불가능합니다.<br/>
								<br/>
								시신기증은 해부학교육과 연구를 위하여 의과대학에 기증하는 것으로 자신의 장기 일부를 환자들에게 대가없이 기증하는 장기기증과는 차이가 있습니다.<br/>
								<br/>
								한국장기조직기증원은 뇌사장기기증 및 인체조직기증 업무를 담당하고 있으며, <span class="text-red-500">생존 시 기증은 각 병원에서 국가의 승인을 받아 진행하고 있습니다.</span>
							</p>

							<div class="section__description tags">
								<span>#뇌사판정</span>
								<span>#장기기증</span>
								<span>#조직기증</span>
								<span>#기증팩트체크</span>
			...
			<div class="sub__fullbox">
				<div class="wrap">
					...
					<div class="item">
						<span><img src="${pageContext.request.contextPath}/resource/assets/images/sub1-i4.png" alt=""></span>
						<p>기증팩트체크</p>
					</div>
				</div>
			</div>
			...
			<div class="wrap">
				<div class="section">
					<h2 class="section__title">뇌사와 식물인간은 엄연히 다릅니다.</h2>
					<p class="section__description ">
					뇌사는 사고 또는 질환으로 <span class="text-red-500">뇌기능이 손상된 상태로 자발적 호흡이 불가능하며,</span><br/>
					<span class="text-red-500">인공호흡기에 의존하여 맥박, 혈압, 호흡 등을 일시적으로 유지할 수 있으나, 어떤 치료 노력에도 2주</span> 이내 사망에 이르는 상태를 말합니다.<br/>
					※ 식물인간은 자발호흡이 가능하고 <span class="text-red-500">수개월~수년 이내 회복 가능성이 있는 상태로 장기기증의 대상이 될 수 없습니다.</span>
					</p>
				</div>

				<div class="flex sub4-imgbox mt-20">
					<div class="flex-1">
				...
				<div class="info-section mt-20" hidden>
