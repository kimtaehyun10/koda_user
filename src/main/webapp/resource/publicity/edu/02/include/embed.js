...
function flashWrite(url,w,h,id,bg,vars,win){
	...
	"<embed src='"+url+"' FlashVars='pageInfo="+vars+"&totalpage="+tolPage+"&chasiNum="+chasiNum+"' wmode='"+win+"' menu='false' quality='high' bgcolor='"+bg+"' width='"+w+"' height='"+h+"' name='"+id+"' align='middle' allowScriptAccess='always' type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />"+
	"</object>";
