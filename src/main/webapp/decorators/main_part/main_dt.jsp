...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nanum+Myeongjo:wght@100;400;500;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/assets/css/normalize.css?v=<?=mktime();?>">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/assets/css/main.css?v=<?=mktime();?>">
