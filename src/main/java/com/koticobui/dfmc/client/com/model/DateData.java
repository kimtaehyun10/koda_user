...
public class DateData {
	...
	// 스케줄 사용시 사용될 생성자
	public DateData(String year, String month, String date, List<Map<String, Object>> value, String schedule, String schedule_detail) {
	...
	// 달력만 사용시 사용될 생성자
	public DateData(String year, String month, String date, List<Map<String, Object>> value) {
