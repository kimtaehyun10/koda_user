...
public class Customer implements UserDetails, CredentialsContainer, Serializable {
    ...
    private final String username; //로그인 사용자 ID
    private final String mberNm; //로그인 사용자 성명
    private String password; //로그인 사용자 패스워드
    private final String userIx; //로그인 사용자 IDX
    private final String userNk; //로그인 사용자 닉네임
    private final Date currentDt; //로그인 시간
    ...
    public Customer(String username, String mberNm, String password, String userIx, String userNk, Date currentDt, String accessToken, Collection<? extends GrantedAuthority> authorities) {
    	this(username, mberNm, password, userIx, userNk, currentDt, accessToken, true, true, true, true, authorities);
    }

    public Customer(String username, String mberNm, String password, String userIx, String userNk, Date currentDt
    				,String accessToken
    				, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked
    				, Collection<? extends GrantedAuthority> authorities) {
    	

        this.username = username; //로그인 사용자 ID
        this.mberNm = mberNm; //로그인 사용자 성명
        this.password = password; //로그인 사용자 패스워드
        this.userIx = userIx; //로그인 사용자 IDX
        this.userNk = userNk; //로그인 사용자 닉네임
        this.currentDt = currentDt; //로그인 시간        

        if (((mberNm == null) || "".equals(mberNm)) || (password == null)) {
	...
	public String getUserIx() {
		return userIx;
	}

	public String getUserNk() {
		return userNk;
	}
