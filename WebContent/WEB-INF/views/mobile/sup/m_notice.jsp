                ...
                bind: function(){
                    ...
                    myGrid.setConfig({
                        ...
                        colGroup: [
                            ...
                            {key:"title", label:"제목", width:100, align:"left"},
...
<!--                         <li><a href="javascript:fn_MovePage('/m/pub/parkingCondition.m');">주차장현황</a></li> -->
                ...
                <li class="sup active">
                    ...
                    <ul>
                        <li class="on"><a href="javascript:fn_MovePage('/m/sup/notice.m');">공지사항</a></li>
