    ...
    <div class="contents">
        <div class="page res">
            ...
            <div class="ct_body">
                <div class="body">
                    <div class="title_img">
                        <img src="${pageContext.request.contextPath}/resource/images/enforcementBasis_img.png" alt="거주자우선주차 시행근거 이미지" />
                    </div>
                    <div class="bd_title">
                        <i class="axi axi-label"></i>
                        <p>주차장법 제7조 (노상주차장의 설치 및 폐지)</p>
                    </div>
                    <div class="block">
                        <p><i class="axi axi-minus"></i>노상주차장은 특별시장, 광역시장, 시장, 군수 또는 구청장이 이를 설치 함</p>
                    </div>
                    <div class="bd_title">
                        <i class="axi axi-label"></i>
                        <p>주차장법 시행규칙 제6조의2</p>
                    ...
                    <div class="block">
                        <p><i class="axi axi-minus"></i>노상주차장의 일부에 대하여 전용주차구획을 설치할 수 있는 경우</p>
                        <p><i class="axi axi-minus"></i>주거지역에 설치된 노상주차장으로서 인근주민의 자동차를 위한 경우</p>
                        <p><i class="axi axi-minus"></i>기타 당해 지방자치단체 조례가 정하는 자동차를 위한 경우</p>
                        <p><i class="axi axi-minus"></i>전용구획 설치, 운영에 관하여 필요한 사항은 당해 지방자치단체의 조례로 정함</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul class="nav">
                <li class="res active">
                    ...
                    <ul>
                        ...
                        <li class="on"><a href="javascript:fn_MovePage('/m/res/enforcementBasis.m');">시행근거</a></li>
