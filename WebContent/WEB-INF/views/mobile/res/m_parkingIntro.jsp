    ...
    <div class="contents">
        <div class="page res">
            ...
            <div class="ct_body">
                <div class="body">
                    <div class="title_img">
                        <img src="${pageContext.request.contextPath}/resource/images/parkingintro_img.png" alt="거주자우선주차 주차장 이미지" />
                    </div>
                    <div class="caption">
                        <p>주택가 이면도로 주차난 해소와 주차질서 확립을 위해 <span>대방, 흑석, 상도, 사당, 노량진, 신대방동</span> 거주자 우선주차장을 관리하고 있습니다.</p>
                    </div>
                    ...
                    <div class="block">
                        <p>이면도로의 주차질서를 확립하여 지역 주민에게 안정적인 주차공간과 편익을 제공하기 위해 만들어진 제도입니다.</p>
                    </div>
                    <div class="bd_title"><!-- 모든 컨텐츠 타이틀 공통 -->
                        <i class="axi axi-label"></i>
                        <p>거주자우선주차란?</p>
                    ...
                    <div class="block">
                        <p>주택가 이면도로의 원활한 교통소통 및 주택난을 해소하고, 이면도로의 주차질서를 확립해 지역 주민에게 안정적인 주차 공간과편익을 제공하기 위해, 주택가 이면도로 등에 주차구획을 설정한 뒤, 유료화하여 인근 주민에게 우선적으로 주차 이용권을 부여하는 제도입니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="menu_box">
            <ul class="nav">
                <li class="res active">
                    ...
                    <ul>
                        <li class="on"><a href="javascript:fn_MovePage('/m/res/parkingIntro.m');">주차장소개</a></li>
