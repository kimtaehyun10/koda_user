                ...
                $.ajax({
                    ...
                    success : function(data, textStatus, jqXHR) {
                        if (data.result == "OK") {
                            ...
                            fn_MovePage('/mypage/memberOut.c');
                        } else {
    ...
    <div class="ct_body">
        <div class="sub_nav">
            <ul>
                ...
                <li><a class="on" href="javascript:fn_MovePage('/mypage/outReconfirm.c');">회원탈퇴</a></li>
            </ul>
        </div>

        <div class="body">
            <div class="caption">
                <p>회원탈퇴는 신중하게 결정하시기 바랍니다.</p>
                <p>본인 확인을 위해 한 번 더 로그인 해주시기 바랍니다.</p>
            </div>
