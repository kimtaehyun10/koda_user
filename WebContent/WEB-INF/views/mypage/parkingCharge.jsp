	        ...
	        grid: { 
	            ...
	            bind: function(){
	                ...
	                payGrid.setList({
	                	...
	                	//2017-07-12 로그인 없이 검색 가능하도록 하기 위해서는 아래 리마크 후 sup를 살리면 됨 - by 한준혁
	                    ajaxUrl: "/mypage/selectRegulatePaymentList.json",
...
<div id="Page" class="page mypage">
    ...
    <div class="ct_body">
        ...
        <div class="body">
            <div class="caption">
                <p>주차요금결제는 공영주차장 이용 후 미결된 주차요금을 결제할 수 있습니다.</p>
                <p>본인의 차량번호를 입력하여 결제 항목을 검색해 주십시오.</p>
            </div>
